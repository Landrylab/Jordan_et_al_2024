...
wt_reads<-read.csv("../Data/validation_variant_count/wt_counts.csv", col.names = c("library", "reads"))
...
cut_df%>%filter(type != "STOP")%>%select(codon, position, condition, interactor, sorbitol, replicate, log2FC)%>%
  pivot_wider(names_from = replicate, values_from = log2FC)%>%
...
motif_screen<-read.csv("../Data/DMS/results/aa_DMS_scores.csv")
...
preliminary_screen<-read.csv("../Data/DMS/results/aa_preliminary_scan_DMS_scores.csv")
...
growthcurves<-read.csv("../Data/growthcurves/DMS_validation_growth_curves/results_validation_growth_curves.csv")%>%
