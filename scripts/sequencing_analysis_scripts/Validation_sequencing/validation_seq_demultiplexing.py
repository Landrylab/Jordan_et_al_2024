...
cutadapt_call="cutadapt -u 36 -U 36 -j 0 -e 0 --discard-untrimmed -g file:./RC_pcr_for.fa -G file:./RC_pcr_rev.fa -o ./demultiplex/{name1}-{name2}.for.fastq.gz -p ./demultiplex/{name1}-{name2}.rev.fastq.gz "+ trimmed_forward+ " " +trimmed_reverse
...
sample_dataframe=pd.read_csv('./validation_sample_datasheet_empty.csv', index_col=0)
...
sample_dataframe.to_csv('./validation_sample_datasheet_demultiplexed_merged.csv', sep=',')