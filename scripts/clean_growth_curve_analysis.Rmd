...
dmso_in<-"../Data/growthcurves/DMS_validation_growth_curves/pbs2_muts_growthcurves_dmso.xlsx" 
mtx_in<-"../Data/growthcurves/DMS_validation_growth_curves/pbs2_muts_growthcurves_mtx.xlsx"
out<-"../Data/growthcurves/DMS_validation_growth_curves/results_validation_growth_curves.csv"
...
dmso_gc<-readxl::read_xlsx(dmso_in, sheet=3)%>%
...
mtx_gc<-readxl::read_xlsx(mtx_in, sheet=3)%>%
  filter(condition %in% c("Sorbitol", "None"))%>%
  mutate(column=as.numeric(column))%>%
...
prelim_dms_data<-read.csv("../Data/DMS/aa_preliminary_scan_DMS_scores.csv")%>%
...
motif_dms_data<-read.csv("../Data/DMS/aa_DMS_scores.csv")%>%
  filter(condition == "MTX" &  interactor == "Sho1")%>%
  select(median_log2FC, sd_log2FC, position, aa, sorbitol)%>%
...
p<-compare%>%
  ...
  # geom_errorbar(aes(ymin=median_mtx_gr-sd_mtx_gr, ymax=median_mtx_gr+sd_mtx_gr), colour="grey80")+
  # geom_errorbarh(aes(xmin=median_log2FC-sd_log2FC, xmax=median_log2FC+sd_log2FC), colour="grey80")+
    geom_point(aes(group=mutation))+
